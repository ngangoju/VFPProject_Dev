...
INSERT INTO `listofmenu` VALUES (1,'admin','2018-10-10 21:32:29','active','2018-10-10 21:32:29','2018-10-10 21:32:29','admin','2018-10-10 21:32:29','Manage MenuGroup','glyphicon glyphicon-asterisk','green2',NULL,'/menu/ViewMenuGroup.xhtml',1,1),
(2,'admin','2018-10-10 21:49:39','active','2018-10-10 21:49:39','2018-10-10 21:49:39','admin','2018-10-10 21:49:39','List of Menu','glyphicon glyphicon-minus','blue2',NULL,'/menu/ViewListOfMenu.xhtml',2,1),
(3,'admin','2018-10-10 21:51:04','active','2018-10-10 21:51:04','2018-10-10 21:51:04','admin','2018-10-10 21:51:04','Menu Assignment','glyphicon glyphicon-asterisk','green2',NULL,'/menu/menuAssignmentForm.xhtml',3,1),
(4,'admin','2018-10-10 22:05:52','active',NULL,'2018-10-10 22:05:52','admin','2018-10-10 22:05:52','Institution Profile','glyphicon glyphicon-minus','blue2','001','/menu/ViewInstitutionProfile.xhtml',NULL,2),
(5,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','Institution Management','glyphicon glyphicon-asterisk','green2','004','/menu/manageInstitutionRegistration.xhtml',NULL,3),
(6,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','User Category','glyphicon glyphicon-minus','blue2','005','/menu/ListOfUserCategory.xhtml',NULL,13),
(7,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','User Management','glyphicon glyphicon-asterisk','green2','006','/menu/ViewUsersList.xhtml',NULL,4),
(8,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','User Contact','glyphicon glyphicon-minus','blue2','007','/menu/ViewUsersContacts.xhtml',NULL,4),
(9,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','User Profile','glyphicon glyphicon-asterisk','green2','008','/menu/ViewProfile.xhtml',NULL,5),
(10,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','Activity Management','glyphicon glyphicon-minus','blue2','009','/menu/Activity.xhtml',NULL,6),
(11,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','Task Management','glyphicon glyphicon-asterisk','green2','010','/menu/Task.xhtml',NULL,7),
(12,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','Manage Activities','glyphicon glyphicon-minus','blue2','011','/menu/ManageActivity.xhtml',NULL,7),
(13,'admin','2018-10-10 22:15:05','active',NULL,'2018-10-10 22:15:05','admin','2018-10-10 22:15:05','Strategic Plan Management','glyphicon glyphicon-asterisk','green2','012','/menu/StrategicPlan.xhtml',NULL,4),
(17,'admin','2018-10-10 22:30:51','active',NULL,'2018-10-10 22:30:51','admin','2018-10-10 22:30:51','Supervisor Report','glyphicon glyphicon-minus','blue2','014','/menu/generalReport.xhtml',NULL,8),
(20,'admin','2018-10-10 22:39:26','active',NULL,'2018-10-10 22:39:26','admin','2018-10-10 22:39:26','Representative Report','glyphicon glyphicon-asterisk','green2','016','/menu/MdReportForm.xhtml',NULL,10),
(21,'admin','2018-10-10 22:39:26','active',NULL,'2018-10-10 22:39:26','admin','2018-10-10 22:39:26','Staff Report','glyphicon glyphicon-minus','blue2','017','/menu/StaffReport.xhtml',NULL,9),
(25,'admin','2018-10-12 09:03:36','active',NULL,'2018-10-12 09:03:36','admin','2018-10-12 09:03:36','Manage Task','glyphicon glyphicon-asterisk','green2','018','/menu/ManageTask.xhtml',NULL,4),
(26,'admin','2018-10-12 09:18:16','active',NULL,'2018-10-12 09:18:16','admin','2018-10-12 09:18:16','Manage Payment Records','glyphicon glyphicon-minus','blue2','019','/menu/ViewPaymentRecords.xhtml',NULL,11),
(27,'admin','2018-10-17 14:54:43','active',NULL,'2018-10-17 14:54:43','admin','2018-10-17 14:54:43','Manage Board','glyphicon glyphicon-asterisk','green2','022','/menu/boardOrganigram.xhtml',NULL,4),
(28,'admin','2018-10-19 22:52:29','active',NULL,'2018-10-19 22:52:29','admin','2018-10-19 22:52:29','Check Notification','glyphicon glyphicon-cloud','blue2','023','/menu/Notification.xhtml',NULL,12),
(31,'admin','2018-10-20 19:41:27','active',NULL,'2018-10-20 19:41:27','admin','2018-10-20 19:41:27','User Management','glyphicon glyphicon-user','green2','024','/menu/ListOfUsers.xhtml',NULL,14);
...
INSERT INTO `menuassignment` VALUES 
(1,'admin','2018-10-10 21:32:47','active','2018-10-10 21:32:47','2018-10-10 21:32:47','admin',NULL,1,1),
(2,'admin','2018-10-10 21:52:16','active','2018-10-10 21:52:16','2018-10-10 21:52:16','admin',NULL,2,1),
(3,'admin','2018-10-10 21:52:55','active','2018-10-10 21:52:55','2018-10-10 21:52:55','admin',NULL,3,1),
(4,'admin','2018-10-11 20:19:53','active',NULL,'2018-10-11 20:19:53','admin',NULL,4,3),
(5,'admin','2018-10-11 20:24:06','active',NULL,'2018-10-11 20:24:06','admin',NULL,5,1),
(6,'admin','2018-10-11 20:25:23','active',NULL,'2018-10-11 20:25:23','admin',NULL,6,3),
(7,'admin','2018-10-11 20:25:55','active',NULL,'2018-10-11 20:25:55','admin',NULL,7,3),
(8,'admin','2018-10-11 20:26:31','active',NULL,'2018-10-11 20:26:31','admin',NULL,8,3),
(9,'admin','2018-10-11 20:27:13','active',NULL,'2018-10-11 20:27:13','admin',NULL,9,3),
(10,'admin','2018-10-11 20:27:49','active',NULL,'2018-10-11 20:27:49','admin',NULL,10,2),
(11,'admin','2018-10-11 20:29:58','active',NULL,'2018-10-11 20:29:58','admin',NULL,11,4),
(12,'admin','2018-10-11 20:30:22','active',NULL,'2018-10-11 20:30:22','admin',NULL,12,4),
(13,'admin','2018-10-11 20:30:57','active',NULL,'2018-10-11 20:30:57','admin',NULL,13,3),
(14,'admin','2018-10-12 08:45:33','active',NULL,'2018-10-12 08:45:33','admin',NULL,17,4),
(15,'admin','2018-10-12 08:48:34','active',NULL,'2018-10-12 08:48:34','admin',NULL,21,2),
(16,'admin','2018-10-12 08:49:02','active',NULL,'2018-10-12 08:49:02','admin',NULL,20,3),
(17,'admin','2018-10-12 09:15:26','active',NULL,'2018-10-12 09:15:26','admin',NULL,25,3),
(18,'admin','2018-10-12 09:26:22','active',NULL,'2018-10-12 09:26:22','admin',NULL,26,1),
(19,'admin','2018-10-17 14:58:07','active',NULL,'2018-10-17 14:58:07','admin',NULL,27,3),
(20,'admin','2018-10-19 22:56:25','active',NULL,'2018-10-19 22:56:25','admin',NULL,28,4),
(21,'admin','2018-10-19 23:30:32','active',NULL,'2018-10-19 23:30:32','admin',NULL,6,1),
(23,'admin','2018-10-20 16:43:59','active',NULL,'2018-10-20 16:43:59','admin',NULL,7,1),
(24,'admin','2018-10-20 17:31:39','active',NULL,'2018-10-20 17:31:39','admin',NULL,9,1),
(25,'admin','2018-10-20 17:31:39','active',NULL,'2018-10-20 17:31:39','admin',NULL,9,2),
(26,'admin','2018-10-20 17:31:39','active',NULL,'2018-10-20 17:31:39','admin',NULL,9,4),
(27,'admin','2018-10-20 19:52:46','active',NULL,'2018-10-20 19:52:46','admin',NULL,31,1);
