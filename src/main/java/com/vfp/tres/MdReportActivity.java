	...
	private void createPieModels() {
	 ...
	 //end  example 
	    ...
	    private BarChartModel initBarModel() {
	        ...
	        for (Object[] data:  taskImpl.reportList("select count(*),a.description,tas.taskName from Activity a  join  a.task tas  group by tas.taskId")){
...
for (Object[] data:  taskImpl.reportList("select t.taskName,t.endDate,t.genericStatus,b.boardName from Task t,Board b  where t.board=b.boardId and t.board='"+selectedBoard+"'")){
