...
public class ChartPresentationController implements Serializable {
	...
	private void createPieModel2() {
		...
		for (Object[] data : usImpl.reportList(
				"select count(*),cat.usercategoryName from Users u  join  u.userCategory cat  group by cat.userCatid")) {
		...
		for (Object[] data : usImpl
				.reportList("select us.fname,us.lname from Contact co right  join  co.user us where co.user is null")) {
	...
	private void createPieModel1() {
		...
		for (Object[] data : usImpl.reportList(
				"select count(*),cat.usercategoryName from UserCategory cat, Users u where u.userCategory=cat.userCatid group by cat.userCatid")) {
